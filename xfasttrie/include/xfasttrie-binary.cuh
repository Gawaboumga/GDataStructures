#ifndef X_FAST_TRIE_BINARY_HPP
#define X_FAST_TRIE_BINARY_HPP
...
class XFastTrieBinary
{
	...
	public:
		...
		__device__ XFastTrieBinary() = default;
		__device__ XFastTrieBinary(block_threads group, gpu::default_allocator& allocator);
		__device__ XFastTrieBinary(threads group, gpu::default_allocator& allocator);
		__device__ XFastTrieBinary(const XFastTrieBinary& other) = default;
		__device__ XFastTrieBinary(XFastTrieBinary&& other) = default;
		...
		__device__ XFastTrieBinary& operator=(const XFastTrieBinary& other) = default;
		__device__ XFastTrieBinary& operator=(XFastTrieBinary&& other) = default;
...
#include "xfasttrie-binary.cu"

#endif // X_FAST_TRIE_BINARY_HPP
